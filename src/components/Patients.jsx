...
function Patients({P_name,age,ward,bed_no,allergy}) {
  return (
    <div className="bg-white   shadow-[0_0px_10px_rgba(0,0,0,0.1)] relative w-[90%] h-32 rounded-2xl  flex pl-4 pt-4 pb-2 ">
      <div className="flex-1 flex gap-1 flex-col ">
        <p className="text-2xl font-bold font-serif" >{P_name}</p>
        <p className="text-gray-500"> age :{age} ward : {ward}</p>
